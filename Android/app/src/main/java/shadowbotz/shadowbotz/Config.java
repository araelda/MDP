...
public class Config {
    ...
    public static final String SHARED_PREF_NAME = "MDPGRP19";//This would be the name of our shared preferences
    ...
    public static String arduino_move_forward_command = "AF";
    public static String arduino_turn_left_command = "AL";
    public static String arduino_turn_right_command= "AR";
    public static String arduino_move_backward_command = "AB";

    public static String algorithm_start_fastest_path = "FP_START";
    public static String algorithm_start_exploration = "EX_START";
    public static String algorithm_end = "END";
